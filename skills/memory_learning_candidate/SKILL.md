# SKILL — مرشح تعلم محكوم

## Skill ID
`memory_learning_candidate`

## Purpose
تسجيل درس مقترح من Error أو Review أو Evidence مع اختبارات ومخاطر قبل اعتماده.
...
## Procedure
1. صف الملاحظة والمصدر.
2. اقترح الدرس بشكل محدود.
3. اربط أدلة وحالات اختبار.
4. احتفظ بالحالة Draft/Pending Review فقط.
