...
## Purpose
صياغة مسودة handoff أو baseline من أدلة وحقائق معتمدة.

## Eligible roles
`documentation_handoff`, `ui_ux_designer`
...
## Procedure
1. اعتمد فقط على facts/decisions/evidence المقبولة.
2. ميز عدم الإثبات.
3. اكتب نقطة الاستئناف والمخاطر.
4. لا تعلن قبولًا أو إصدارًا من تلقاء نفسها.
