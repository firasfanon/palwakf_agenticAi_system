# SKILL — مراجعة جاهزية الإصدار

## Skill ID
`release_readiness_review`

## Purpose
تقييم build/lint/tests/env/staging/UAT/rollback evidence قبل الإصدار دون نشر.
...
## Procedure
1. تحقق من evidence لكل بوابة.
2. حدد النواقص.
3. اخرج Go/No-Go recommendation مشروطة.
4. لا تنشر.
