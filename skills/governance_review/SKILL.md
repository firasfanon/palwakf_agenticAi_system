# SKILL — مراجعة الحوكمة

## Skill ID
`governance_review`

## Purpose
فحص التزام المهمة بالحدود والصلاحيات ومصادر الحقيقة وبوابات الاعتماد.
...
## Procedure
1. قارن المهمة بالعقود والسياسات.
2. تحقق من الاستقلالية والأدوات.
3. حدد أي تجاوز أو نقص اعتماد.
4. اخرج قبول مشروط أو رفض مسبب.
