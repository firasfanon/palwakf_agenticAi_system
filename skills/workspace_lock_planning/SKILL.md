# SKILL — تخطيط قفل مورد

## Skill ID
`workspace_lock_planning`

## Purpose
اقتراح قفل لمورد مشترك قبل تنفيذ مستقبلي، دون إنشاء قفل فعلي أو worktree.
...
## Procedure
1. حدد المورد والمهام المتعارضة.
2. حدد المالك والمدة والمراجعة.
3. صنف أثر التعارض.
4. لا تنشئ Git branch أو worktree.
