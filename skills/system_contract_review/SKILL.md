# SKILL — مراجعة عقود النظام

## Skill ID
`system_contract_review`

## Purpose
تحديد الواجهات والعقود التي لا يجوز كسرها دون قرار واختبار توافق.
...
## Procedure
1. حدد مصدر الحقيقة والمستهلكين.
2. حدد التغيير المسموح/المحظور.
3. حدد اختبار التوافق.
4. صعد عند تعارض عقدين.
