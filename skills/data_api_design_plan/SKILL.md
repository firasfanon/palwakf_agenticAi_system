# SKILL — خطة نموذج البيانات وAPI

## Skill ID
`data_api_design_plan`

## Purpose
تصميم جداول وعلاقات وAPI وAuthorization بشكل تخطيطي مع فهارس وValidation وRollback considerations.

## Eligible roles
`solution_architect`, `backend_engineer`, `database_engineer`
...
## Procedure
1. حدد الكيانات والعلاقات.
2. صنف البيانات الحساسة.
3. حدد قواعد قراءة/كتابة خادم.
4. لا تكتب SQL أو Migrations أو RLS.
