...
$backupRoot = Join-Path $project "backups\command_center_operational_ui_ux_read_only_v1_reva_$timestamp"
...
$manifest = [ordered]@{
  package_id = "MEGA_BATCH_COMMAND_CENTER_OPERATIONAL_UI_UX_READ_ONLY_V1_REVA"
