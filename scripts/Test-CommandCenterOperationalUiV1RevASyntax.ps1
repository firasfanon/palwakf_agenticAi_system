...
$required = @(
  ...
  "static\styles.css",
  "static\app.js",
  "scripts\Test-CommandCenterOperationalUiV1RevASyntax.ps1",
  "scripts\Test-CommandCenterOperationalUiV1RevAPreflight.ps1",
  "scripts\Test-CommandCenterOperationalUiV1RevAStaticEval.ps1",
  "scripts\Install-CommandCenterOperationalUiV1RevA.ps1",
  "docs\README_OPERATIONAL_UI_UX_READ_ONLY_V1_REVA_AR.md",
  "docs\SECURITY_CONTRACT_OPERATIONAL_UI_UX_READ_ONLY_V1.md",
  "docs\UAT_OPERATIONAL_UI_UX_READ_ONLY_V1_AR.md",
  "MANIFEST_OPERATIONAL_UI_UX_READ_ONLY_V1_REVA.md"
)
