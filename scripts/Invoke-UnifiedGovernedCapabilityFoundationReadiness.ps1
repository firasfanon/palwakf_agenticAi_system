...
$syntax=Join-Path $PackageRoot 'scripts\Test-UnifiedGovernedCapabilityFoundationCandidateSyntax.ps1'
$preflight=Join-Path $PackageRoot 'scripts\Test-UnifiedGovernedCapabilityFoundationPreflight.ps1'
$installer=Join-Path $PackageRoot 'scripts\Install-UnifiedGovernedCapabilityFoundationV1.ps1'
...
& $installer -PackageRoot $PackageRoot -ProjectRoot $ProjectRoot -PreflightManifest $preflightManifest -WhatIf
